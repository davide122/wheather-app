...
<h1 className="Nome">{cities.slice(-1)}</h1>
</div>
...
{citta.weather? <h1 className="Nome s">{citta.weather[0].description}</h1> : null}
  {citta.main? <h1 className="Nome s">{citta.main.temp} °K</h1> : null}
</div>

<div className="d-flex my-5 justify-content-center align-items-center my-5 border-top">
 
{citta.wind? <h1 className="Nome mx-5"><svg width={60} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512"><path d="M288 32c0 17.7 14.3 32 32 32h32c17.7 0 32 14.3 32 32s-14.3 32-32 32H32c-17.7 0-32 14.3-32 32s14.3 32 32 32H352c53 0 96-43 96-96s-43-96-96-96H320c-17.7 0-32 14.3-32 32zm64 352c0 17.7 14.3 32 32 32h32c53 0 96-43 96-96s-43-96-96-96H32c-17.7 0-32 14.3-32 32s14.3 32 32 32H416c17.7 0 32 14.3 32 32s-14.3 32-32 32H384c-17.7 0-32 14.3-32 32zM128 512h32c53 0 96-43 96-96s-43-96-96-96H32c-17.7 0-32 14.3-32 32s14.3 32 32 32H160c17.7 0 32 14.3 32 32s-14.3 32-32 32H128c-17.7 0-32 14.3-32 32s14.3 32 32 32z"/></svg>{citta.wind.speed}m/s  </h1>:null}
...
{citta.wind? <h1 className="Nome mx-5">{citta.wind.speed}</h1>:null}
